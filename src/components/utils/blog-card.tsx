...
const BlogCard = ({ blog }: Props) => {
    return (
        <AnimationContainer key={blog.title} className="w-full">
            <MagicCard gradientSize={150}>
                <div className="flex flex-col w-full items-start px-3 py-2 md:px-6 rounded-md md:rounded-lg md:py-4 overflow-hidden relative transition ease-out">
